        ...
        <multiple name="days">
          ...
          <if @days.active_p@ true>
            <if @days.today_p@ true>
              <td headers="day_@days.day_num@" id="d@days.date@" <if @days.class@ >onMouseOut="hideCalendarTasks()"  onMouseOver="showCalendarTasks('@days.date@','@base_url@','#planner.activities#')"</if> class="today" onclick="javascript:location.href='@days.url@#calendar';" onkeypress="javascript:acs_KeypressGoto('@days.url@#calendar',event);">
                <a href="@days.url@#calendar" class="@days.class@" title="#calendar.goto_days_pretty_date#">@days.day_number@</a>
              </td>
            </if>
            <else>
              <td headers="day_@days.day_num@" id="d@days.date@" <if @days.class@ >onMouseOut="hideCalendarTasks()"  onMouseOver="showCalendarTasks('@days.date@','@base_url@','#planner.activities#')"</if> class="active" onclick="javascript:location.href='@days.url@#calendar';" onkeypress="javascript:acs_KeypressGoto('@days.url@#calendar',event);">
                <a href="@days.url@#calendar" class="@days.class@" title="#calendar.goto_days_pretty_date#">@days.day_number@</a>
              </td>
            </else>
          </if>
